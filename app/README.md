...
# For getting financial data (required for stock price/fundamentals)
FINANCIAL_DATASETS_API_KEY=your-financial-datasets-api-key
```

> **Note (personal):** I've found that setting up `FINANCIAL_DATASETS_API_KEY` early saves headaches — several agents silently fail without it.
